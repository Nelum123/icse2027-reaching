...
- `icfg/parser{a..f}.json` — inter-procedural CFGs (required for structural ground truth).
- `ground_truth_structural_logprob/parser{a..f}.json` — per-block structural log-probabilities.
